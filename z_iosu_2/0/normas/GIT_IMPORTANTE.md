## actualiza
git remote add upstream https://github.com/ollama/ollama.git; git fetch upstream




actualiz un pr
git fetch upstream pull/13259/head:pr-13259
git merge pr-13259; if (Test-Path z_iosu_2) { Write-Host 'z_iosu_2 preserved' } else { Write-Host 'z_iosu_2 missing' }



git fetch upstream

git branch backup-13-prtest; git reset --hard upstream/main; git checkout backup-13-prtest -- z_iosu_2; git commit -m "Restore z_iosu_2 folder after sync with upstream"
