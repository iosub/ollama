...
# Paso 3: Instalar SDK
Write-Host "[INFO] Iniciando instalacion Vulkan SDK..." -ForegroundColor Yellow
...
# Paso 4: Encontrar ruta de instalacion
...
# Paso 5: Crear script de configuracion de entorno
...
# Paso 6: Aplicar configuracion en sesion actual
& $ConfigScript
